...
|===
| Bloque de Construcción | Componente de Infraestructura | Punto de Mapeo
...
| Puerto 80. Puerta de entrada al sistema;

| **Base de Datos (MongoDB)**
| Contenedor (puerto 27017)
| Puerto 27017.
...
| Conecta todos los contenedores.
|===
...
* **Puerto 4000 (Gamey)**: Este servicio es el núcleo de la aplicación, encargado de gestionar la lógica del juego y las interacciones entre los jugadores. Incluye volumen para logs y variables de entorno (`DB_URI`, `REDIS_URI`).
