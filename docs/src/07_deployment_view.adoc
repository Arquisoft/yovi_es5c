...
graph LR
    ...
    %% Aplicar Clases
    class App,Gateway,UserS, greenFill
    class MongoDb,QDB dbFill
----
...
* **Puerto 9091 (Grafana)**: Se utiliza para la visualización de datos conectandose a Prometheus para mostrar las métricas recopiladas en paneles gráficos.
