...
El informe global puede ser consultado aquí: link:https://github.com/user-attachments/files/26765734/Resultados_test_carga.pdf[Resultados_test_carga.pdf]
...
image:requests_gatling.png[Peticiones exitosas con estadísticas de tiempo de respuesta]

image:active_users_gatling.png[Gráfica de usuarios activos simultáneamente durante la ejecución]
