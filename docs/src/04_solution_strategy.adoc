...
En vistas a cumplir los atributos de calidad requeridos en cualquier sistema moderno, se toman las siguientes decisiones, asociadas a metas u objetivos específicos:

*Rendimiento y Eficiencia*: La lógica de cálculo intensivo (validación de movimientos y fin de partida) se delega íntegramente al módulo de Rust. Esto garantiza tiempos de respuesta mínimos incluso en tableros de gran tamaño, aprovechando la gestión de memoria eficiente y la velocidad de ejecución de un lenguaje de sistemas.
